...
class Form extends Component {
    ...
    render() {
        ...
        let { formContent, loading } = this.props
        return (
            <div className="bp3-ui-text">
                ...
                <Divider />
                <Button intent={Intent.PRIMARY} onClick={() => this.props.onSubmit(this.props.formContent)} loading={loading}>Ajouter / Modifier</Button>
            </div>
        )
    }
}
