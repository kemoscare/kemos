                ...
                <div className="bp3-ui-text">
                    ...
                    <FormGroup label="Organe" labelFor="select-organ">
                        <HTMLSelect
                            name="organ"
                            id="organ"
                            options={selectContent.organs[formContent.theme]}
                            value={formContent.organ}
                            onChange={this.handleSelectChange}
                            fill={true}
                        />
                    </FormGroup>
                    <RadioGroup
                        ...
                        label="Catégorie"
                        inline
                        selectedValue={formContent.radio_radiochimiottt}
                    >
                        <Radio label="Chimiothérapie" value="Chimiotherapie" />
                        <Radio
                            label="Radio-Chimiothérapie"
                            value="Radiochimiotherapie"
                        />
                        <Checkbox
                            inline
                            id="clinicalTrial"
                    ...
                    <ControlGroup>
                        ...
                        >
                            <InputGroup
                                ...
                                placeholder="0"
                                id="dayOneEquals"
                                value={formContent.dayOneEquals}
                            />
                        </FormGroup>
                    </ControlGroup>

                    <FormEvaluation
                        evaluations={formContent.evaluations || []}
                    />
                    <Divider />
                    ...
                    <Button
                        ...
                        onClick={() =>
                            this.props.onSubmit(this.props.formContent)
                        }
                        loading={sendingChemoLoading}
                    >
                        Ajouter / Modifier
                    </Button>
                </div>
